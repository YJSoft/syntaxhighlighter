 ...
 **/
class syntaxhighlighter extends EditorHandler
{
	...
	function syntaxhighlighter($editor_sequence, $component_path)
	{
	...
	{
		$script_path = getScriptPath().'modules/editor/components/syntaxhighlighter/syntaxhighlighter/scripts/';
